...
abstract class Processor{
  ...
  static String get _equation => _firstValue
  ...
  static void handleInteger(CalculatorKey key) {
    ...
    if (_operator == null) { _firstValue = (_firstValue == '0') ? val : _firstValue + val; }
    else { _secondValue = (_secondValue == '0') ? val : _secondValue + val; }
    refresh();
  }
  ...
  static void _sign() {
    ...
    if (_secondValue != '0') { _secondValue = (_secondValue.contains('-') ? _secondValue.substring(1) : '-' + _secondValue); }
    else if (_firstValue != '0') { _firstValue = (_firstValue.contains('-') ? _firstValue.substring(1) : '-' + _firstValue); }
  }
  ...
  static void _percent() {
    ...
    if (_secondValue != '0' && !_secondValue.contains('.')) { _secondValue = calcPercent(_secondValue); }
    else if (_firstValue != '0' && !_firstValue.contains('.')) { _firstValue = calcPercent(_firstValue); }
  }

  static void _decimal() {

    if (_secondValue != '0' && !_secondValue.contains('.')) { _secondValue = _secondValue + '.'; }
    else if (_firstValue != '0' && !_firstValue.contains('.')) { _firstValue = _firstValue + '.'; }
  }

  static void _calculate() {

    if (_operator == null || _secondValue == '0') { return; }
    ...
    double result = table[_operator](double.parse(_firstValue), double.parse(_secondValue));
